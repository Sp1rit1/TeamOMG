...
TOKEN = '7347774244:AAEFjVvYR5qtkXOIBTyAJhAl3IWJ2wiq7HY'  # Replace with your actual token
...
async def handle_message(update: Update, context):
    ...
    try:
        ...
        response = ollama.chat(model='llama:latest', messages=context_memory[user_id])
